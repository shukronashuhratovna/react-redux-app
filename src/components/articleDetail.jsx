...
import { getArticleDetailStart, getArticleDetailSuccess, getArticleDetailError } from "../slice/article"
        ...
        <div className="p-5 mb-4 bg-body-tertiary rounded-3">
            {isLoading ? (<Loader />) : articleDetail !== null &&
                <div className="container-fluid py-5">
                    ...
                    <p className="text-muted"><span className="fw-bold">Created at: </span>
                        {moment(articleDetail.createdAt).format("DD MMM YYYY")}</p>
